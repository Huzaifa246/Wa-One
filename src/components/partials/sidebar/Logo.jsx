...
// import images
import MobileLogoWhite from "@/assets/images/logo/waone-Single.png";

// Siderbar open karne ky baad laptop size wala logo
      ...
      <Link to="/dashboard">
        <div className="flex items-center">
          <div className="logo-icon">
            {!isDark && !isSemiDark ? (
              <img src={MobileLogoWhite} alt="" width={"35px"} />
            ) : (
              <img src={MobileLogoWhite} alt="" width={"40px"} class={"mx-2"} />
            )}
          </div>

          {(!collapsed || menuHover) && (
            <div>
              <h1 className="text-xl font-semibold text-slate-900 dark:text-slate-100 px-2">
                WA-ONE
              </h1>
            </div>
          )}
